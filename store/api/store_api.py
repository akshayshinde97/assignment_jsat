        ...
        if request.method == "OPTIONS":  # CORS preflight
            ...
            try:
                ...
                store_query = StoreMetadata.query.filter(
                    StoreMetadata.name == store_json['name'], StoreMetadata.address == store_json['address']).one_or_none()

                if store_query:
                    return response_json(False, {}, f"{store_json['name']} Store already exist")
                ...
                return response_json(True, {}, f"Successfully added {store_json['name']}")
            except Exception as e:
                print(traceback.format_exc(), e)
        ...
        if request.method == "OPTIONS":  # CORS preflight
            ...
            try:
                ...
                if existing_store:
                    ...
                    return response_json(True, {}, f"{store_json['id']} successfully deleted")
                else:
                    response_json(True, {}, f"Store ID {store_json['id']} not found")
